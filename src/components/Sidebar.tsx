...
export default function Sidebar({ currentTab, onChangeTab, user, onLogout }: SidebarProps) {
  ...
  return (
    <div className="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen select-none shrink-0 border-r border-slate-800">
      {/* Brand Header */}
      ...
      <div className="px-6 py-4 bg-slate-950/40 border-b border-slate-800/40 flex items-center gap-3">
        <div className="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center font-bold text-indigo-800 text-sm">
